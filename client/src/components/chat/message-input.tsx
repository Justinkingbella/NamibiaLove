...
const MessageInput: React.FC<MessageInputProps> = ({
  ...
  return (
    <div className="bg-white p-1.5 shadow-lg border-t border-gray-100">
      <div className="flex items-center gap-2">
        {isRecording ? (
          ...
          <div className="flex-1 relative">
            <Input
              type="text"
              placeholder="Message..."
              className="w-full rounded-full px-4 py-2.5 focus-visible:ring-1 focus-visible:ring-primary border-gray-100 bg-[#F8F5F0] shadow-md pl-10"
              value={value}
        ...
        <Button
          ...
          className="rounded-full w-10 h-10 border-none bg-[#F8F5F0] shadow-md"
